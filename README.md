...
```javascript
import MILLISECONDS_IN_WEEK from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-week@v0.3.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-time-milliseconds-in-week/actions/workflows/test.yml/badge.svg?branch=v0.3.3
[test-url]: https://github.com/stdlib-js/constants-time-milliseconds-in-week/actions/workflows/test.yml?query=branch:v0.3.3
